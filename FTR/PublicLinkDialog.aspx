...
<html>
    <head runat="server">
        <title><%=Language.GetEntry("FileVista.Label.EditPublicLink")%></title>
    </head>
    <body>
        <form id="form1" runat="server" autocomplete="off">
            ...
            <table cellpadding="4" cellspacing="0" border="0" style="width: 100%;">
                ...
                <tr>
                    <td colspan="2" style="text-align: right">
                        ...
                        <asp:Button ID="ButtonUpdate" runat="server" style="width: 80px" OnClick="ButtonUpdate_Click" OnClientClick="onSubmit()" />
                    </td>
                </tr>
                <tr>
                    <td colspan="2"><hr/></td>
            ...
            <div style="position: absolute; bottom: 10px; width: 384px;">
                <asp:Button ID="ButtonTest" runat="server" style="width: 80px; float:left" OnClientClick="onButtonTestClick(); return false;" />
                <asp:Button ID="ButtonEmail" runat="server" style="width: 80px; float:left; margin-left: 5px" OnClientClick="onButtonEmailClick(); return false;" />
                <asp:Button ID="ButtonClose" runat="server" style="width: 80px; float:right" OnClientClick="elementDialog.close(); return false;" />
            </div>
        </form>
    </body>
</html>
