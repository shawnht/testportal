				                ...
				                <tr>
				                    <td>
                                        ...
                                        <table id="tableVistaDB" border="0" cellpadding="0" cellspacing="10"  style="margin-left: 10px;">
                                            <tr>
                                                <td colspan="2">
                                                It is recommended that you keep the VistaDB Database file (.vdb4 file) in the default location.
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <b>Important:</b> Current Windows Identity should have <i>Modify</i> permission on the folder that contains the .vdb4 file.
                                                </td>
                                            </tr>
                                        </table>
				                    </td>
...
<%case 3:%>
                        <div id="divSetupStep3" runat="server">
                            <table border="0" cellpadding="0" cellspacing="10" >
                                ...
                                <tr>
                                    <td colspan="2">Choose a default culture for the application. The user interface language, number and date/time formats are dependant on the selected culture.
                                    Note that users will be able to override the default culture with their own cultures on the login page or user settings page.</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">Define a test root folder. You can later change/delete this root folder or add another one on the administration page. The path can be a physical path (c:\some\folder), a virtual path (/some/folder) or a web application relative path (~/some/folder).</td>
                                </tr>
                                <tr>
