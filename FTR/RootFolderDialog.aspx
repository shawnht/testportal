        ...
        <form id="form1" runat="server">
            ...
            <table cellpadding="4" cellspacing="0" border="0" style="width: 100%">
	            ...
	            <tr>
	                ...
	                <td>
	                    <asp:TextBox ID="Location" runat="server" style="width: 250px" MaxLength="255"></asp:TextBox>
	                    <asp:RequiredFieldValidator ID="LocationValidator" runat="server" ControlToValidate="Location" ValidationGroup="RootFolderRequired" SetFocusOnError="true" ForeColor="red" Font-Bold="True">!</asp:RequiredFieldValidator>
	                </td>
                    <td colspan="2">
                        <%if (RootFolderId == 0)
                          {%>
                        <input type="button" id="LoadButton" value="<%=Language.GetEntry("FileVista.Action.Load") %>" onclick="onLoadButtonClick(this)" style="width: 80px"/>
                        <% } %>
                    </td>
                </tr>
                <%} %>
            ...
            <hr/>
            <div id="divMembers" style="width: 750px">
