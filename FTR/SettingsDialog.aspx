            ...
            <div id="tabPanel">
	            <div class="tab">
		    	    <table cellpadding="0" cellspacing="10" border="0" style="width: 100%;">
                        <tr>
                            <td><%=Language.GetEntry("638")%></td>
                            <td align="right"><asp:DropDownList ID="DropDownListCultures" runat="server" style="width: 250px"></asp:DropDownList></td>
                        </tr>
                        <tr>
                            <td colspan="2"><hr /></td>
                        </tr>
                ...
                <div class="tab">
		    	    <table cellpadding="0" cellspacing="10" border="0" style="width: 100%;">
                        <tr>
                            <td><%=Language.GetEntry("Label.ViewLayout")%>:</td>
                            <td align="right">
                                <asp:DropDownList ID="DropDownViewLayout" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2"><hr /></td>
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <asp:TextBox ID="TextBoxMaxZipFileSize" runat="server"  style="width: 75px; text-align: right" MaxLength="10"></asp:TextBox>
                                <asp:DropDownList ID="DropDownMaxZipFileSize" runat="server">
                        ...
                        <tr>
                            ...
                            <td align="right"><asp:Textbox ID="TextboxTemporaryFolder" runat="server" style="width:125px" /></td>
                        </tr>
                    </table>
                </div>
                <div class="tab">
    		    	<table cellpadding="0" cellspacing="10" border="0" style="width: 100%;">
                        <tr>
                            <td colspan="2">
                                <fieldset style="padding: 0; margin-top: 10px"><legend style="color:black; text-align:center"><%=Language.GetEntry("639")%></legend>
